...
import elrehabImg from "../public/Assets/Projects/Elrehab.jpg";
    ...
    <div className="w-full">
      <div className="relative w-screen h-[30vh] lg:h-[40vh]">
        ...
        <div className="absolute max-w-[1240px] w-full top-[60%] p-4 text-[#fff] z-10">
          <h2 className="py-2">Elrehab clothing Inc</h2>
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-5 gap-8 pt-8 p-2">
        <div className="col-span-4">
          ...
          <button className="px-8 py-2 mr-8 mt-4">
            <a
              href="https://github.com/Ahmedadelkhalil/el-rehab"
              target="blank"
            >
              Code
            </a>
          ...
          <button className="px-8 py-2 mt-4">
            <a
              href="https://ahmedadelkhalil.github.io/el-rehab/"
              target="blank"
            >
              Demo
            </a>
